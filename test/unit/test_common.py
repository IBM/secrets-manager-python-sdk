...
import unittest
from ibm_secrets_manager_sdk import common
...
class TestCommon(unittest.TestCase):
    ...
    def test_get_sdk_headers(self):
        ...
        """
        headers = common.get_sdk_headers(service_name='example_service', service_version='V1',
                                         operation_id='operation1')
        self.assertIsNotNone(headers)
        self.assertIsNotNone(headers.get('User-Agent'))
        self.assertIn('secrets-manager-sdk-python', headers.get('User-Agent'))
